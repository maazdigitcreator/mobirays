      ...
      {status.loading ? (
        ...
        <div className="flex flex-col gap-6 px-2 sm:px-0">
          {currentReplies.map((reply) => (
            ...
            >
              <div className="w-full md:w-1/4 flex flex-col group">
                <Link
                  to={
                    reply.subjectSlug
                      ? `/review/${reply.subjectSlug}`
                      : "/reviews"
                  }
                  className="relative mb-3 flex justify-center items-center p-2 bg-blue-50/50 rounded-lg h-48 transition-transform group-hover:scale-105"
                >
