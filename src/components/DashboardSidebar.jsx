...
const DashboardSidebar = () => {
  ...
  const navItems = [
    ...
    { name: "Admin Review Replies", path: "/admin-review-replies" },
    { name: "News Review Replies", path: "/news-review-replies" },
  ];
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              to={item.path}
              key={item.path}
              className={`w-full text-center py-3 transition-all duration-300 ease-in-out cursor-pointer ${
                isActive
