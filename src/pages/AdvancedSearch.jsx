        ...
        <div className="w-full lg:w-3/4">
          ...
          <div className="mb-8 overflow-hidden bg-white">
            ...
            <div className="flex items-center justify-center gap-3 px-4 py-5">
              <span className="rounded-l-full border-2 border-[#0580A5] px-4 py-1 text-3xl">
                Result
              </span>
              ...
              <button
                ...
                className="cursor-pointer rounded-r-full border-2 border-[#0580A5] bg-[#0580A5] px-6 py-1 text-3xl font-light text-white transition-colors hover:bg-[#046a88]"
              >
                SHOW ALL
          ...
          {bannerUrl && (
            <img
              className="mt-7 h-[200px] w-auto sm:w-full"
              src={bannerUrl}
