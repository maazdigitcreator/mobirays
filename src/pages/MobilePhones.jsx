        ...
        <div>
            <div className='flex flex-col lg:flex-row gap-2'>
                ...
                <div className="w-full lg:w-3/4">
                    ...
                    <div>
                        <LatestProducts title={searchQuery ? `Search Results for "${searchQuery}"` : "Latest Phones"} products={currentProducts} itemImage={mobileImg} />
                    ...
                    {pageBanners['phones_banner_1'] && <img className='mt-7 h-[200px] w-auto sm:w-full' src={pageBanners['phones_banner_1']} alt="Phones Banner 1" />}
                    <div className='mt-10'>
                        <LatestNews
                            title="News"
            ...
            <div className="md:col-span-3 mb-6 overflow-hidden">
                {pageBanners['phones_banner_2'] && <img className='mt-7 w-auto sm:w-full h-[200px] sm:h-auto' src={pageBanners['phones_banner_2']} alt="Phones Banner 2" />}
            </div>
