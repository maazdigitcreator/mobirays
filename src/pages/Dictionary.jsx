        ...
        <div>
                ...
                <div className="w-full lg:w-3/4">
                    ...
                    <div className="w-full">
                        ...
                        <div
                            ...
                            style={pageBanners['dictionary_banner_1'] ? { backgroundImage: `url(${pageBanners['dictionary_banner_1']})` } : {}}
                        >
            ...
            {pageBanners['dictionary_banner_2'] && (
                <div className='mt-8 mb-8'>
                    <img className='w-full h-auto' src={pageBanners['dictionary_banner_2']} alt="Banner" />
                </div>
            )}
        </div>
    )
