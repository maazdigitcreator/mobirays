                ...
                <div className="w-full lg:w-3/4">
                    ...
                    <div ref={commentsSectionRef}>
                        ...
                        <div className="space-y-3 px-2 sm:px-0">
                            ...
                            <div className="flex flex-row gap-3 justify-between sm:justify-end items-center mt-2">
                                <Link to="/reviews" className="flex items-center justify-center border-2 border-[#0580A5] text-black sm:px-6 px-3 py-2 rounded-full hover:bg-[#0580A5] hover:text-white transition-colors text-sm sm:text-base cursor-pointer whitespace-nowrap">
                                    Read All Reviews&gt;&gt;
                                </Link>
