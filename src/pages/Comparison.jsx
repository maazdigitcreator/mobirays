        ...
        <div>
            <div className="flex flex-col lg:flex-row gap-2">
                ...
                <div className="w-full lg:w-2/3">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 mb-6 px-2">
                        {[0, 1, 2].map((index) => (
                            <div key={index} className={`relative ${index === 2 ? 'hidden lg:block' : ''}`}>
                                {/* Header */}
                                <div className=" py-2 ">
                                ...
                                <div className="">
                                    ...
                                    <p className="text-[8px] sm:text-xs text-[#41403E] mt-2 flex items-center gap-1">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 mb-6 px-2">
                        {[0, 1, 2].map((index) => {
                            ...
                            return device ? (
                                <div key={device.id || index} className={index === 2 ? 'hidden lg:block' : ''}>
                                    <DeviceComparisonCard device={device} />
                                </div>
                            ) : (
                                <div key={index} className={index === 2 ? 'hidden lg:block' : 'block'}></div> // Placeholder for empty slot
                            );
                        })}
                    </div>
